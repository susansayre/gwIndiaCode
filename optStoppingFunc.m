...
%actions are invest (x=1) or don't invest (x=0)
    ...
    switch flag
        ...
        case 'f'
            ...
            costBore = P.electricityBore*lift; %+ exp(P.costBore_a+P.costBore_b*levels);

            gwDug = min(P.idDugInt/P.idDugSlope*(1-min(1,max(0,lift-P.depthFullD)/(P.maxDepthDug-P.depthFullD))),max(0,(P.idDugInt-costDug)./P.idDugSlope));
